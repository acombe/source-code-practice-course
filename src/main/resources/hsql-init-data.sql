...
insert into messages (text, dateAndTime, owner, topic) values ('Où est-ce que vous voulez partir pour le voyage de la boite cette année ?', NOW(), 0, 0);
insert into messages (text, dateAndTime, owner, topic) values ('Moi ça m''est égal, tant qu''il y fait beau et chaud !', NOW(), 1, 0);
insert into messages (text, dateAndTime, owner, topic) values ('J''ai toujours rèvé de visiter Madère...', NOW(), 2, 0);
insert into messages (text, dateAndTime, owner, topic) values ('Madère ? C''est où ça ? Moi j''aimerais mieux aller en Norvège ou en Suède.', NOW(), 3, 0);
